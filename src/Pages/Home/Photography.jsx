                                ...
                                return (
                                    <SwiperSlide key={i} className="relative full-screen flex flex-col items-center justify-center font-serif bg-cover bg-center xs:h-[664px]" style={{ backgroundImage: `url(${item.img})` }}>
                                        <Swiper
                                            ...
                                            className="absolute top-1/2 w-full -translate-y-1/2 text-[115px] leading-[235px] tracking-[0px] font-bold uppercase opacity-10 z-0 swiper-auto-slide lg:text-[75px] sm:text-[55px] xs:leading-[35px] xs:text-[40px]">
                                        ...
                                        <Row className="h-full">
                                            <Col className="h-full justify-center items-center flex flex-col">
                                                <m.div
                                                    ...
                                                    className="relative overflow-hidden font-serif text-center text-[115px] xl:text-[100px] lg:text-[75px] lg:leading-[75px] md:text-[60px] sm:text-[55px] xs:text-[40px] xs:leading-[50px] leading-none font-bold uppercase landscape:md:text-[35px] landscape:md:leading-[35px]">
                        ...
                        <Row className="justify-center">
                            <Overlap>
                                <Col className="relative text-center">
                                    <m.img width={385} height={705} src="/assets/img/photo6.png" className="mx-auto mt-[5.5rem] xs:mt-32" alt="photography" {...{ ...zoomIn, transition: { duration: 0.7 } }} />
                                </Col>
                            </Overlap>
                        </Row>
                        <Row className="justify-center">
